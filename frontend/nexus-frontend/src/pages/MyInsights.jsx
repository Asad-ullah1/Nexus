...
const MyInsights = () => {
  ...
  const fetchMyInsights = useCallback(async () => {
    ...
    try {
      ...
      setError('Failed to fetch your insights. Please try again.');
  ...
  if (loading) {
    return (
      <Container className="py-4 text-center">
        ...
        <p className="mt-2">Loading your insights...</p>
      </Container>
    );
  }
  ...
  return (
    <Container className="py-4">
      ...
      <div className="mb-4">
        <Form.Group>
          <InputGroup>
            ...
            <Form.Control
              type="text"
              placeholder="Search your insights by title, summary, or tags..."
              value={search}
      ...
      {insights.length === 0 ? (
        ...
        <div className="text-center py-5">
          <h3 className="text-muted">No insights match your search</h3>
              ...
              <Card className="h-100 border-primary">
                <Card.Body className="d-flex flex-column">
                  ...
                  <div className="d-flex gap-2">
                    <Button variant="outline-primary" size="sm" onClick={() => handleEdit(insight)}>
                      Edit
                    </Button>
                    <Button
